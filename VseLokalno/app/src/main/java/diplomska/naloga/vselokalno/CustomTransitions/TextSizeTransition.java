package diplomska.naloga.vselokalno.CustomTransitions;
...
public class TextSizeTransition extends Transition {
    private static final String PROPNAME_TEXT_SIZE = "diplomska:naloga:vselokalno:transition:textsize";
    ...
    /*@Override
    public void captureStartValues(@NonNull androidx.transition.TransitionValues transitionValues) {
        captureValues(transitionValues);
    }

    @Override
    public void captureEndValues(@NonNull androidx.transition.TransitionValues transitionValues) {
        captureValues(transitionValues);
    }*/
